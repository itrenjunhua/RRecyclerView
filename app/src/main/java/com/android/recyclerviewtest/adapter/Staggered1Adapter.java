 ...
 * <p/>
 * 描述：StaggeredGridLayoutManager 类型 StaggeredGridLayoutManager.VERTICAL 的Adapter
 * <p/>
 * 修订历史：
 * <p/>
 * ======================================================================
...
public class Staggered1Adapter extends SingleTypeAdapter<String> {
    // 保存每一个 item 的高度，防止瀑布流图片闪烁问题
    private HashMap<String, Integer> saveHeight = new HashMap<>();
    private BaseActivity activity;

    public Staggered1Adapter(Context context, List datas, int layoutID) {
