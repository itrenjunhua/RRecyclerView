...
public class List2Activity extends BaseActivity {
    ...
    private void setRecyclerView() {
        ...
        final ListGridAdapter adapter = new ListGridAdapter(this, datas, LinearLayoutManager.HORIZONTAL);
        ...
        adapter.setOnItemLongClickListener(new SingleTypeAdapter.OnItemLongClickListener<String>() {
            ...
            public boolean onItemLongClick(View itemView, int position, List<String> datas, String itemData) {
                ...
                ToastUtil.showSingleToast(List2Activity.this, "长按 位置:" + position + "；数据:" + itemData);
                return true;
            }
        });
    }
