 ...
 * ======================================================================
 */
public class StaggeredVerticalImageCell extends BaseRecyclerCell<SimpleMultiItemEntity<String>> {
    ...
    public StaggeredVerticalImageCell(GlideUtils glideUtils) {
        super(R.layout.item_staggred_1);
