...
public abstract class BaseRecyclerCell<D> {
     ...
     * 绑定 holder
     */
    public abstract void onBindViewHolder(@NonNull RecyclerViewHolder holder, ViewDataBinding viewDataBinding, int position, D itemData);

    @SuppressWarnings("unused")
    public void onAttachedToWindow(@NonNull RecyclerViewHolder holder, ViewDataBinding viewDataBinding) {
     ...
     */
    @SuppressWarnings("unused")
    public void onDetachedFromWindow(@NonNull RecyclerViewHolder holder, ViewDataBinding viewDataBinding) {
    ...
    public void onItemClick(@NonNull Context context, @NonNull RecyclerAdapter recyclerAdapter,
                            ...
                            @NonNull View itemView, int position, D itemData) {
